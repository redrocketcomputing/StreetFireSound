 ...
 *
 * $Id: SkipForwardCommand.java,v 1.1 2005/03/16 04:23:42 stephen Exp $
 */
 ...
 */
public class SkipForwardCommand implements AbstractCommand
{
   ...
   */
  public SkipForwardCommand(MediaPlayerClient client)
  {
    // Save the client
    this.client = client;
  }
  ...
  {
    // Forward
    client.skipSync(0, ConstSkipDirection.FORWARD, 1);
  }
