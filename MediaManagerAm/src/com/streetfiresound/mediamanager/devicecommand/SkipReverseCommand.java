 ...
 *
 * $Id: SkipReverseCommand.java,v 1.1 2005/03/16 04:23:42 stephen Exp $
 */
 ...
 */
public class SkipReverseCommand implements AbstractCommand
{
  private MediaPlayerClient client;

  /**
   * Construct PauseCommand
   * @param client The MediaPlayerClient to issue the Pause command
   */
  public SkipReverseCommand(MediaPlayerClient client)
  {
    // Save the client
    this.client = client;
  }
  ...
  {
    // Forward
    client.skipSync(0, ConstSkipDirection.REVERSE, 1);
  }
