 ...
 *
 * $Id: BooleanRule.java,v 1.2 2005/02/24 03:03:34 stephen Exp $
 */
...
public class BooleanRule extends RuleDefinition
{
   ...
   */
  public BooleanRule(BooleanType it)
  {
    super(it);
  }
  ...
  public void outputToFile(java.io.OutputStream ostream)throws java.io.IOException
  {
    ...
    //output data type to outputstream
    ostream.write("boolean".getBytes());
  }
