 ...
 *
 * $Id: LiteralRule.java,v 1.2 2005/02/24 03:03:35 stephen Exp $
 */
 ...
 */
public class LiteralRule extends RuleDefinition
{

  /**
   * Constructor for LiteralRule.
   */
  public LiteralRule(LiteralType it)
  {
    super(it);
  }
...
//      HaviType outString = (HaviType) driver.scope.get(ht.getTypeName());

//      if(outString == null)
          ostream.write(ht.getTypeName().getBytes());
//      else
//          outString.output(ostream);
