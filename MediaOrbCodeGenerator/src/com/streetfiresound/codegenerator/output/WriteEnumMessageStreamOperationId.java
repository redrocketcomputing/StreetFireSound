 ...
 *
 * $Id: WriteEnumMessageStreamOperationId.java,v 1.2 2005/02/24 03:03:36 stephen Exp $
 */
 ...
 */
public class WriteEnumMessageStreamOperationId
{
   ...
   */
  public WriteEnumMessageStreamOperationId(EnumType et) throws IOException
  {
    super();
    this.et = et;
...
//     String location = "/" + driver.BASEOUTPUTPATH.replace('.','/') + "/" + driver.CONSTANTPATH.replace('.', '/');;
  ...
  private void printContent1(OutputStream os) throws IOException
  {
        ...
        while(iter.hasNext())
        {
		 ...
		 CodeGenerator.messageStreamEventList.add(vName);
...
//		String constantValue = (String)CodeGenerator.haviapi.get(CodeGenerator.currentPackage.toUpperCase());	//012303
        ...
        while(iter.hasNext())
        {
          ...
          CodeGenerator.messageStreamOpCodeList.add(vName);
