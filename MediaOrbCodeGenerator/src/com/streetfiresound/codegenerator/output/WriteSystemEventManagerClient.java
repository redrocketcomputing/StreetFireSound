 ...
 *
 * $Id: WriteSystemEventManagerClient.java,v 1.2 2005/02/24 03:03:36 stephen Exp $
 */
 ...
 */
public class WriteSystemEventManagerClient implements ConstTypeDefinition
{
   ...
   */
  public WriteSystemEventManagerClient(InterfaceType it, HashMap constantMap)  throws IOException
  {
    super();
...
//	{
			...
			FileOutputStream fos = new GplHeaderFileOutputStream(location+"/"+CodeGenerator.currentPackage+ "SystemEventManagerClient.java");
			outputToFile(fos);
			fos.close();
//	}
...
//	printFireLoop(os);
  ...
  private void printClass(OutputStream os) throws IOException
  {
    ...
    os.write("SystemEventManagerClient ".getBytes());
  ...
  private void printImplement(OutputStream os) throws IOException
  {
		...
		os.write(CodeGenerator.currentPackage.getBytes());
		os.write("SystemEventConstant".getBytes());
...
*/
  ...
  private void printConstructor(OutputStream os) throws IOException
  {
      ...
      os.write(CodeGenerator.currentPackage.getBytes());
      os.write("SystemEventManagerClient(SoftwareElement softwareElement) throws HaviMsgException, HaviEventManagerException, Havi".getBytes());
      os.write(CodeGenerator.currentPackage.getBytes());
      os.write("Exception\n".getBytes());
...
//      os.write("\t\teventManagerClient = new EventManagerClient(softwareElement, null);\n".getBytes());
      ...
      private void printFunctionBody(FunctionType ft, OutputStream os, int loopCount) throws IOException
      {
				...
				if(ct != null)
				{
		                ...
		                os.write("\t\t\t// Post the event\n".getBytes());
										...
										os.write("\t\t\tEventId eventId = new SystemEventId(ConstSystemEventType.".getBytes());
