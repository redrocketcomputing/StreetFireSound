 ...
 *
 * $Id: WriteMessageStreamInvocation.java,v 1.2 2005/02/24 03:03:36 stephen Exp $
 */
 ...
 */
public class WriteMessageStreamInvocation implements ConstTypeDefinition
{
		...
		public WriteMessageStreamInvocation(FunctionType ft) throws IOException
		{
			super();
			this.ft = ft;
...
//			FileOutputStream fos = new FileOutputStream( location + "/" + ft.getTypeName() + "MessageStreamInvocation.java");
			FileOutputStream fos = new GplHeaderFileOutputStream( location + "/" + className + "MessageStreamInvocation.java");
...
//			os.write(ft.getTypeName().getBytes());
			...
			os.write("MessageStreamInvocation extends MessageStreamInvocation\n".getBytes());
		...
		private void printConstructor(OutputStream os) throws IOException
		{
			...
			os.write("MessageStreamInvocation(HaviByteArrayInputStream hbais) throws HaviUnmarshallingException\n".getBytes());
			os.write("\t{\n\n".getBytes());
		...
		private void printDispatch(OutputStream os) throws IOException
		{
			...
			os.write("\tpublic void dispatch(MessageStreamListener listener)\n".getBytes());
			os.write("\t{\n\n".getBytes());
			...
			os.write("MessageStreamListener))\n".getBytes());
			os.write("\t\t\t{\n".getBytes());
			...
			os.write("MessageStreamListener".getBytes());
