 ...
 *
 * $Id: RestoreMaintenanceClient.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class RestoreMaintenanceClient extends MaintenanceClient
{

  /**
   * Create and negotiate a restore maintenance request
   ...
   */
  public RestoreMaintenanceClient(GUID guid) throws MaintenanceException
  {
    super(guid, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_RESTORE);
  }
   ...
   * connection setup or handshake negotiations
   */
  public RestoreMaintenanceClient(String ipAddress, int ipPort) throws MaintenanceException
  {
    super(ipAddress, ipPort, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_RESTORE);
  }
  ...
  {
    // Forward to parent
    startAsynchronousSend(file, listener);
  }
}
