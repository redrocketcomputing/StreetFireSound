 ...
 *
 * $Id: BackupMaintenanceRequestFactory.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class BackupMaintenanceRequestFactory extends MaintenanceRequestFactory
{
  /* (non-Javadoc)
  ...
  {
    // Check request type
    if (request.getFeatureCode() == Rbx1600MaintenanceConstants.FEATURE_CODE_BACKUP)
    {
      // Create the handler
      return new BackupMaintenanceRequestHandler(inputStream, outputStream);
    }
