 ...
 *
 * $Id: UpgradeMaintenanceRequestFactory.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class UpgradeMaintenanceRequestFactory extends MaintenanceRequestFactory
{

  /**
   * Contruct a new UpgradeMaintenanceRequestFactory
   */
  public UpgradeMaintenanceRequestFactory()
  {
    super();
  }
  ...
  {
    // Check request type
    if (request.getFeatureCode() == Rbx1600MaintenanceConstants.FEATURE_CODE_UPDATE)
    {
      // Create the handler
      return new UpgradeMaintenanceRequestHandler(inputStream, outputStream);
    }
