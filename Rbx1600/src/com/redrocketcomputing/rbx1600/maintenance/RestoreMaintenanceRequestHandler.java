 ...
 *
 * $Id: RestoreMaintenanceRequestHandler.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class RestoreMaintenanceRequestHandler implements MaintenanceRequestHandler
{
  private DataInputStream inputStream;
  private DataOutputStream outputStream;

  /**
   * Construct an RestoreMaintenanceRequestHandler
   * @param inputStream The request input stream
   * @param outputStream The request output stream
   */
  public RestoreMaintenanceRequestHandler(DataInputStream inputStream, DataOutputStream outputStream)
  {
  ...
  public void executeRequest() throws MaintenanceException
  {
    try
    {
      ...
      LoggerSingleton.logInfo(this.getClass(), "executeRequest", "restoring database");

      // Create file object for the restore file
      File restoreFile = new File("/opt/streetfire/backup.rbx1600");
      ...
      Process checkProcess = Runtime.getRuntime().exec("/sbin/check_backup");
