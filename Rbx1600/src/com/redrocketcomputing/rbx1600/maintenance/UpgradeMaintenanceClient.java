 ...
 *
 * $Id: UpgradeMaintenanceClient.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class UpgradeMaintenanceClient extends MaintenanceClient
{

  /**
   * Create and negotiate a upgrade maintenance request
   ...
   */
  public UpgradeMaintenanceClient(GUID guid) throws MaintenanceException
  {
    super(guid, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_UPDATE);
  }
   ...
   * connection setup or handshake negotiations
   */
  public UpgradeMaintenanceClient(String ipAddress, int ipPort) throws MaintenanceException
  {
    super(ipAddress, ipPort, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_UPDATE);
  }
