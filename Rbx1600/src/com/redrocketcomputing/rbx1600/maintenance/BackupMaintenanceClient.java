 ...
 *
 * $Id: BackupMaintenanceClient.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class BackupMaintenanceClient extends MaintenanceClient
{
  /**
   * Create and negotiate a backup maintenance request
   ...
   */
  public BackupMaintenanceClient(GUID guid) throws MaintenanceException
  {
    super(guid, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_BACKUP);
  }
   ...
   * connection setup or handshake negotiations
   */
  public BackupMaintenanceClient(String ipAddress, int ipPort) throws MaintenanceException
  {
    super(ipAddress, ipPort, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_BACKUP);
  }
