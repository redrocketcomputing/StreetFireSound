 ...
 *
 * $Id: GetDeviceLogMaintenanceClient.java,v 1.1 2005/02/22 03:47:23 stephen Exp $
 */
 ...
 */
public class GetDeviceLogMaintenanceClient extends MaintenanceClient
{

  /**
   * Create and negotiate a get device log maintenance request
   ...
   */
  public GetDeviceLogMaintenanceClient(GUID guid) throws MaintenanceException
  {
    super(guid, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_GET_LOG);
  }
   ...
   * connection setup or handshake negotiations
   */
  public GetDeviceLogMaintenanceClient(String ipAddress, int ipPort) throws MaintenanceException
  {
    super(ipAddress, ipPort, (byte)Rbx1600MaintenanceConstants.FEATURE_CODE_GET_LOG);
  }
