...
import com.streetfiresound.client.AppFramework; //XXX:00000:20050326iain: get rid of this dependency
...
public class LiquidLookAndFeel extends BasicLookAndFeel {
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        try {
            ...
            boolean isPanelTransparent = Boolean.valueOf(liquidProps.get(
                        "panelTransparency").toString()).booleanValue();
            LiquidLookAndFeel.setPanelTransparency(isPanelTransparent);

            boolean areGridsShowed = Boolean.valueOf(liquidProps.get(
                        "showTableGrids").toString()).booleanValue();
            LiquidLookAndFeel.setShowTableGrids(areGridsShowed);

            boolean doStipples = Boolean.valueOf(liquidProps.get("stipples")
                                                            .toString())
                                        .booleanValue();
            LiquidLookAndFeel.setStipples(doStipples);

            boolean altBackground = Boolean.valueOf(liquidProps.get(
                        "alternateBackground").toString()).booleanValue();
            LiquidLookAndFeel.setDefaultRowBackgroundMode(altBackground);

            boolean isPanther = liquidProps.get("windowDecoration").toString()
                                           .equalsIgnoreCase("panther");
            LiquidLookAndFeel.winDecoPanther = isPanther;

            boolean isFlatted = Boolean.valueOf(liquidProps.get(
                        "toolbarFlattedButtons").toString()).booleanValue();
            LiquidLookAndFeel.toolbarFlattedButtons = isFlatted;
  ...
  protected void initSystemColorDefaults(UIDefaults table)
  {
    ...
    for (Enumeration e = AppFramework.uiProperties.propertyNames(); e.hasMoreElements(); )
    {
      ...
      String prefix = "ColorMap.";
      if (prop.startsWith(prefix))
      {
        //System.out.println("XXX:000000000000000000:iain:>>>>prop.substring(prefix.length()), TestClient.uiProperties.getProperty(prop) is '" + prop.substring(prefix.length()) + ", " +  TestClient.uiProperties.getProperty(prop) + "'");
        colorMap.put(prop.substring(prefix.length()), AppFramework.uiProperties.getProperty(prop));
      }
    }
...
//         colorMap.put("activeForeground", "#444444");
//         colorMap.put("activeTitleBtnBg", "#AFD6FF");
//         colorMap.put("alternateBackground", "#222222");
//         colorMap.put("background", "#444444");
//         colorMap.put("buttonBackground", "#F27B35");
//         colorMap.put("buttonForeground", "#DDDDDD");
//         colorMap.put("foreground", "#EEEEEE");
...
//         colorMap.put("selectBackground", "#F27B35"); bright orange"#FF9600"); //orange  // slate blue:"#5B70A5");
//         colorMap.put("selectForeground", "#030303");
//         colorMap.put("visitedLinkColor", "#800080");
//         colorMap.put("windowBackground", "#333333");
//         colorMap.put("windowForeground", "#000000");
    ...
    protected void initComponentDefaults(UIDefaults table) {
        ...
        table.put("InternalFrame.normalTitleFont", getFont(Font.BOLD, 14));
        ...
        table.put("InternalFrame.pantherIcon",
            loadIcon("panther-blue.png", this));
        table.put("InternalFrame.pantherIconInactive",
    ...
    public static void setLiquidDecorations(boolean b, String type) {
        javax.swing.JFrame.setDefaultLookAndFeelDecorated(b);
        javax.swing.JDialog.setDefaultLookAndFeelDecorated(b);
