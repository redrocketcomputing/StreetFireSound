 ...
 * <p>
 * <code>LiquidRootPaneUI</code> provides support for the
 * <code>windowDecorationStyle</code> property of <code>JRootPane</code>.
 * <code>LiquidRootPaneUI</code> does this by way of installing a custom
...
public class LiquidRootPaneUI extends BasicRootPaneUI {
    ...
    void installBorder(JRootPane root) {
        ...
        if (style == JRootPane.NONE) {
            ...
            // installs an instance of LiquidFrameBorder
    ...
    private JComponent createTitlePane(JRootPane root) {
        return new LiquidTitlePane(root, this);
    }
    ...
    /**
     * Invoked when a property changes. <code>LiquidRootPaneUI</code> is
        ...
        public void mouseDragged(MouseEvent ev) {
            ...
            if (isMovingWindow) {
                ...
                if (!r.equals(startBounds)) {
                    ...
                    //System.out.println("\nw.setBounds() " + System.currentTimeMillis());
