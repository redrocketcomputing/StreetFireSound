...
class LiquidTitlePane extends JComponent {
    ...
    private void setState(int state, boolean updateRegardless) {
        ...
        if ((w != null) && (getWindowDecorationStyle() == JRootPane.FRAME || getWindowDecorationStyle() == JRootPane.PLAIN_DIALOG)) {
            ...
            if (isSelected) {
                ...
                if (!LiquidLookAndFeel.winDecoPanther) {
                    GradientPaint grad = new GradientPaint(xOffset +
                            ...
                            xOffset + (titleLength / 2), fm.getHeight() + 6,
                            new Color(102, 186, 255));
                    g2.setPaint(grad);

                    g2.fillRoundRect(xOffset - 8, yOffset - 15,
                        titleLength + 15, height - 6, 18, 18);
    ...
    private class TitlePaneLayout implements LayoutManager {
        ...
        public void layoutContainer(Container c) {
            ...
            spacing = LiquidLookAndFeel.winDecoPanther ? 2 : 0;
