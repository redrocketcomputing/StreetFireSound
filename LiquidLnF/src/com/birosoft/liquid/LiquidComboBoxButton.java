...
public class LiquidComboBoxButton extends JButton
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        Insets insets = new Insets(6, 12, 6, 2);
    ...
    public Skin getSkinCombo()
    {
        if (skinCombo == null)
        {
          skinCombo = new Skin("toolbar-button.png", 5, 15, 15, 15, 15); // L, T, R, B
          skinCombo.colourImage();
          //skinCombo = new Skin("combobox.png", 4, 10, 9, 18, 11);
        }
        return skinCombo;
    }
