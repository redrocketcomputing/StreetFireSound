 ...
 *
 * $Id: FreeMemoryCommand.java,v 1.1 2005/02/22 03:54:48 stephen Exp $
 */
 ...
 *
 */
public class FreeMemoryCommand extends InternalShellCommand
{

  /**
   * Constructor for FreeMemoryCommand.
   * @param parent The parent shalle
   */
  public FreeMemoryCommand(Shell parent)
  {
    super(parent);
  }
  ...
  {
    return "Displays the amount of free memory in the VM";
  }
  ...
  public int run(String[] args)
  {
    ...
    out.println(Runtime.getRuntime().freeMemory() + " bytes free");
