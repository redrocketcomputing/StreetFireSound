 ...
 *
 * $Id: TotalMemoryCommand.java,v 1.1 2005/02/22 03:54:48 stephen Exp $
 */
 ...
 *
 */
public class TotalMemoryCommand extends InternalShellCommand
{

  /**
   * Constructor for TotalMemoryCommand.
   * @param parent The parent shell for this command
   */
  public TotalMemoryCommand(Shell parent)
  {
    super(parent);
  }
  ...
  {
    return "Display the total memory for the VM";
  }
  ...
  public int run(String[] args)
  {
    ...
    out.println(Runtime.getRuntime().totalMemory() + " bytes");
