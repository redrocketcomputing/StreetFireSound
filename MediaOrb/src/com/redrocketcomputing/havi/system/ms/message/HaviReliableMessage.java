 ...
 *
 * $Id: HaviReliableMessage.java,v 1.1 2005/02/22 03:44:27 stephen Exp $
 */
 ...
 *
 */
public class HaviReliableMessage extends HaviMessage
{
  private int messageLength = -1;
  private byte[] body = EMPTY;

  /**
   * Constructor for HaviReliableMessage.
   */
  public HaviReliableMessage()
  {
    // Contruct super class
    super();

    // Set the message type
    messageType = ConstTransferProtocolMessageTypes.RELIABLE;
  }
   ...
   * @param body
   */
  public HaviReliableMessage(SEID destination, SEID source, int protocolType, int messageNumber, byte[] body)
  {
    ...
    this.messageType = ConstTransferProtocolMessageTypes.RELIABLE;
   ...
   */
  public HaviReliableMessage(HaviByteArrayInputStream hbais) throws HaviUnmarshallingException
  {
    // Forward
    unmarshal(hbais);
  }
  ...
  {
    return new HaviReliableMessage(destination, source, protocolType, messageNumber, body);
  }
  ...
  {
    // Check type
    if (o instanceof HaviReliableMessage)
    {
      // Cast it up
      HaviReliableMessage other = (HaviReliableMessage)o;
  ...
  {
    handler.handleReliableMessage(this);
  }
