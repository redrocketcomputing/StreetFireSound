 ...
 *
 * $Id: TransferProtocolEventListener.java,v 1.1 2005/02/22 03:44:26 stephen Exp $
 */
...
public interface TransferProtocolEventListener
{
  /**
   * Handle a new message
   * @param message The new message
   * @return int The reliable ack code
   */
