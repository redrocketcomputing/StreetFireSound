 ...
 *
 * $Id: NetworkReadyEventListener.java,v 1.1 2005/02/22 03:44:26 stephen Exp $
 */
 ...
 *
 */
public interface NetworkReadyEventListener extends EventListener
{
  /**
   * Handle messaging system network ready event
   * @param activeDevices The active device on the network
   * @param nonactiveDevices The non-active devices on the network
   * @param newDevices The new devices on the network
   * @param goneDevices The disappeared devices on the network
   */
