 ...
 *
 * $Id: GadpNackGuidMessage.java,v 1.1 2005/02/22 03:44:26 stephen Exp $
 */
 ...
 */
public class GadpNackGuidMessage extends GadpMessage
{
  ...
  /**
   * Constructor for GadpNackGuidMessage.
   */
  public GadpNackGuidMessage()
  {
  }

  public GadpNackGuidMessage(GUID guid, int timestamp)
  {
  ...
  public GadpNackGuidMessage(HaviByteArrayInputStream hbais) throws HaviUnmarshallingException
  {
    // Forward
    unmarshal(hbais);
  }
  ...
  {
    // Forward
    handler.handleNackGuid(guid, timestamp);
  }
  ...
  {
    // Check type
    if (o instanceof GadpNackGuidMessage)
    {
      // Cast it up
      GadpNackGuidMessage other = (GadpNackGuidMessage)o;
  ...
  {
    return "GadpNackGuidMessage: " + guid + ' ' + timestamp;
  }
