 ...
 *
 * $Id: DcmCodeUnitInterface.java,v 1.2 2005/02/24 03:30:23 stephen Exp $
 */
...
{
  /**
   * Install an Dcm code unit
   * @param instanceName The instanceName of the DcmCodeUnit
   * @param targetId The TargetId of the Dcm
   ...
   * @return 0 if the Dcm installed sucessfully, otherwise 1.
   */
