...
public class DeviceUpgrade
{
  private static void usage(String message)
  {
    ...
    // Display usage
    System.out.println("DeviceUpgrade <host address> <file>");
  }
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    File upgradeFile = new File(args[1]);
    
    // Create restore client
    UpgradeMaintenanceClient client = new UpgradeMaintenanceClient(args[0], Rbx1600MaintenanceConstants.PORT + 46000);
    
    // Start the backup
    client.start(upgradeFile, new ProgressListener());
  }
