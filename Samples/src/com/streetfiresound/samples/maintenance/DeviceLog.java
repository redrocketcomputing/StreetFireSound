...
public class DeviceLog
{
  private static void usage(String message)
  {
    ...
    // Display usage
    System.out.println("DeviceLog <host address> <file>");
  }
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    GetDeviceLogMaintenanceClient client = new GetDeviceLogMaintenanceClient(args[0], Rbx1600MaintenanceConstants.PORT + 46000);
