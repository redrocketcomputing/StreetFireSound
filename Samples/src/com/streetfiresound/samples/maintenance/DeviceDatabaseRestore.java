 ...
 */
public class DeviceDatabaseRestore
{
  private static void usage(String message)
  {
    ...
    // Display usage
    System.out.println("DeviceDatabaseRestore <host address> <file>");
  }
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    File restoreFile = new File(args[1]);
    
    // Create restore client
    RestoreMaintenanceClient client = new RestoreMaintenanceClient(args[0], Rbx1600MaintenanceConstants.PORT + 46000);
    
    // Start the backup
    client.start(restoreFile, new ProgressListener());
  }
