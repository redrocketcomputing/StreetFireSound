...
public class DeviceReboot
{
  private static void usage(String message)
  {
    ...
    // Display usage
    System.out.println("DeviceReboot <host address> <file>");
  }
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    RebootDeviceMaintenanceClient client = new RebootDeviceMaintenanceClient(args[0], Rbx1600MaintenanceConstants.PORT + 46000);
    
    // Start the backup
    client.start(logFile, new ProgressListener());
  }
